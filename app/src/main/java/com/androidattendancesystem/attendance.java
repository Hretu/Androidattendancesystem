...
//                adapter.saveAll();
        ...
        adapterSpinner = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_dropdown_item, AppBaseActivity.divisions);
        assert spinner != null;
    ...
    public void loadListView(View view) {
        ...
        String qu = "SELECT * FROM STUDENT WHERE cl = '" + spinner.getSelectedItem().toString() + "' " +
                "ORDER BY ROLL";
        Cursor cursor = AppBaseActivity.handler.execQuery(qu);
